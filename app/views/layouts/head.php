...
<link rel="stylesheet" href="<?= asset('vendor/fontawesome/releases/v6.6.0/css/sharp-duotone-solid.css'); ?>">
<link rel="stylesheet" href="<?= asset('vendor/fontawesome/releases/v6.6.0/css/sharp-light.css'); ?>">
